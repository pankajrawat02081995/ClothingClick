...
extension StoreProfileVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0{
            ...
            debugPrint(self.viewModel.otherUserDetailsData?.show_email_on_app)
            debugPrint(self.viewModel.otherUserDetailsData?.phone)
            debugPrint((self.viewModel.otherUserDetailsData?.show_email_on_app ?? false == true) ||  (self.viewModel.otherUserDetailsData?.phone?.isEmpty == false && self.viewModel.otherUserDetailsData?.phone != nil))
//            if (self.viewModel.otherUserDetailsData?.show_email_on_app ?? false == false) ||  (self.viewModel.otherUserDetailsData?.phone?.isEmpty == false && self.viewModel.otherUserDetailsData?.phone != nil){
//                cell.viewContact.isHidden = false
//            }else{
//                cell.viewContact.isHidden = true
//            }
            
//            cell.viewDirections.isHidden = self.viewModel.otherUserDetailsData?.locations?.isEmpty ?? true || self.viewModel.otherUserDetailsData?.locations == nil
