...
public class EFImageViewZoom: UIScrollView {
    ...
    public override func awakeFromNib() {
        ...
        self.setupTap()
        self.delegate = self
        //NotificationCenter.default.addObserver(self, selector: #selector(screenOrientationChanged), name: NSNotification.Name.UIDevice.orientationDidChangeNotification, object: nil)
    }
