...
class BrandProfileViewController: BaseViewController {
...
//        if appDelegate.userDetails?.isEmailShow() ?? false || appDelegate.userDetails?.isPhoneShow() ?? false{
...
//        }
        ...
        self.lbltitle.text = "\(self.haderTitle) Nmae"
...
extension BrandProfileViewController : UICollectionViewDelegate,UICollectionViewDataSource {
...
extension BrandProfileViewController: LikeDelegate{
...
extension BrandProfileViewController: UICollectionViewDelegateFlowLayout {
...
extension BrandProfileViewController {
...
extension BrandProfileViewController : UIPopoverPresentationControllerDelegate {
    func adaptivePresentationStyle(for controller: UIPresentationController) -> UIModalPresentationStyle {
        return .none
    }
}
extension BrandProfileViewController : ShortByDelegate{
...
extension BrandProfileViewController: CustomMenuDelegate {
