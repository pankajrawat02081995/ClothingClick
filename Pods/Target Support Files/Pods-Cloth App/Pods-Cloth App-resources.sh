...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Cosmos/Cosmos.bundle"
  ...
  install_resource "${PODS_ROOT}/MercariQRScanner/QRScanner/Images.xcassets"
  ...
  install_resource "${BUILT_PRODUCTS_DIR}/YPImagePicker/YPImagePicker.framework/YPLibraryView.nib"
